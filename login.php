...
<head>
  ...
  <title>EAZYN</title>
  <link rel="shortcut icon" type="image/png" href="assets/images/logos/eazyn-logo.png" />
            ...
            <div class="card mb-0">
              <div class="card-body">
                ...
                <form action="proses_login.php" method="post">
                  ...
                  <input type="submit" class="btn btn-primary w-100 py-8 fs-4 mb-4 rounded-2">Sign In</a>
